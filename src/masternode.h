...
//Now using rolling collateral table in validation.h
...
//
// The Masternode Class. It contains the input of the 10000 PAWS, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 10000 PAWS - checking if valid masternode)
