...
const unsigned char PAWS_PREVOUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'P','I','V','X','P','r','e','v','o','u','t','H','a','s','h'};
const unsigned char PAWS_SEQUENCE_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'P','I','V','X','S','e','q','u','e','n','c','H','a','s','h'};
const unsigned char PAWS_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'P','I','V','X','O','u','t','p','u','t','s','H','a','s','h'};
const unsigned char PAWS_SHIELDED_SPENDS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'P','I','V','X','S','S','p','e','n','d','s','H','a','s','h'};
const unsigned char PAWS_SHIELDED_OUTPUTS_HASH_PERSONALIZATION[crypto_generichash_blake2b_PERSONALBYTES] =
        {'P','I','V','X','S','O','u','t','p','u','t','H','a','s','h'};



uint256 GetPrevoutHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, PAWS_PREVOUTS_HASH_PERSONALIZATION);
...
uint256 GetSequenceHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, PAWS_SEQUENCE_HASH_PERSONALIZATION);
    for (unsigned int n = 0; n < txTo.vin.size(); n++) {
...
uint256 GetOutputsHash(const CTransaction& txTo) {
    CBLAKE2bWriter ss(SER_GETHASH, 0, PAWS_OUTPUTS_HASH_PERSONALIZATION);
...
uint256 GetShieldedSpendsHash(const CTransaction& txTo) {
    assert(txTo.sapData);
    CBLAKE2bWriter ss(SER_GETHASH, 0, PAWS_SHIELDED_SPENDS_HASH_PERSONALIZATION);
...
uint256 GetShieldedOutputsHash(const CTransaction& txTo) {
    assert(txTo.sapData);
    CBLAKE2bWriter ss(SER_GETHASH, 0, PAWS_SHIELDED_OUTPUTS_HASH_PERSONALIZATION);
    auto sapData = txTo.sapData;
...
uint256 SignatureHash(const CScript& scriptCode, const CTransaction& txTo, unsigned int nIn, int nHashType, const CAmount& amount, SigVersion sigversion, const PrecomputedTransactionData* cache)
{
    ...
    if (sigversion == SIGVERSION_SAPLING) {
        ...
        memcpy(personalization, "PAWSSigHash", 12);
