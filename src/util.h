...
extern const char * const PAWS_CONF_FILENAME;
extern const char * const PAWS_PID_FILENAME;
extern const char * const PAWS_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("paws-%s", name);
