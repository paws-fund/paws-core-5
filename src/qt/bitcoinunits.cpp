...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(PAWS);
    unitlist.append(mPAWS);
    unitlist.append(uPAWS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case PAWS:
        return QString("paws");
    case mPAWS:
        return QString("mpaws");
    case uPAWS:
        return QString::fromUtf8("upaws");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZpaws)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPAWS)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZPAWS);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZPAWS)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZPAWS));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
