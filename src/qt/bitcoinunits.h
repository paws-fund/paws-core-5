...
/** PAWS unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    //! Short name
    static QString name(int unit, bool isZpaws = false);
    //! Longer description
    ...
    static QString floorWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZPAWS = false);
    static QString floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign = false, SeparatorStyle separators = separatorStandard, bool cleanRemainderZeros = false, bool isZPAWS = false);
