...
// Copyright (c) 2015-2018 The PAWS developers
...
/* Paws GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "PAWS"
#define QAPP_ORG_DOMAIN "paws.org"
#define QAPP_APP_NAME_DEFAULT "PAWS-Qt"
#define QAPP_APP_NAME_TESTNET "PAWS-Qt-testnet"
