...
/** Utility functions used by the PAWS Qt UI.
 */
namespace GUIUtil
{
...
// Render PAWS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZpaws = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZpaws = false);
...
// Parse "paws:" URI into recipient object, return true on successful parsing
