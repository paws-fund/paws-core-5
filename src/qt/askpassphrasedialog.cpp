...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            PAWSGUI* window = static_cast<PAWSGUI*>(parentWidget());
...
{
    PAWSGUI* gui = static_cast<PAWSGUI*>(parentWidget());
...
{
    hide();
    static_cast<PAWSGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("PAWS will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your PAWSs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
