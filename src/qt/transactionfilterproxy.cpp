...
bool TransactionFilterProxy::filterAcceptsRow(int sourceRow, const QModelIndex& sourceParent) const
{
    ...
    if (fOnlyStakesandMN && !isStakeTx(type) && !isMasternodeRewardTx(type)) return false;
...
bool TransactionFilterProxy::isOrphan(const int status, const int type)
{
    return ( (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint ||
            type == TransactionRecord::StakeZPAWS || type == TransactionRecord::MNReward)
...
bool TransactionFilterProxy::isZcTx(int type) const {
    return (type == TransactionRecord::ZerocoinMint || type == TransactionRecord::ZerocoinSpend || type == TransactionRecord::ZerocoinSpend_Change_zPaws
...
bool TransactionFilterProxy::isStakeTx(int type) const {
    //return type == TransactionRecord::StakeMint || type == TransactionRecord::Generated || type == TransactionRecord::StakeZPAWS || type == TransactionRecord::StakeDelegated;
   return type == TransactionRecord::StakeMint || type == TransactionRecord::Generated /*|| type == TransactionRecord::StakeZPAWS*/ || type == TransactionRecord::StakeDelegated;
}
