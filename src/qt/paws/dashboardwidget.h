...
#include "config/paws-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    QList<qreal> valuesPaws;
    //QList<qreal> valueszPaws;
...
public:
    explicit DashboardWidget(PAWSGUI* _window);
    ~DashboardWidget();
