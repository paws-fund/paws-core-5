...
#ifndef PAWS_CORE_NEW_GUI_PAWSGUI_H
#define PAWS_CORE_NEW_GUI_PAWSGUI_H
...
#include "qt/paws/navmenuwidget.h"
#include "qt/paws/topbar.h"
#include "qt/paws/dashboardwidget.h"
#include "qt/paws/send.h"
#include "qt/paws/receivewidget.h"
#include "qt/paws/addresseswidget.h"
#include "qt/paws/coldstakingwidget.h"
#include "qt/paws/masternodeswidget.h"
#include "qt/paws/snackbar.h"
#include "qt/paws/settings/settingswidget.h"
...
/**
  PAWS GUI main class. This class represents the main window of the PAWS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PAWSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit PAWSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~PAWSGUI();
...
#endif //PAWS_CORE_NEW_GUI_PAWSGUI_H
