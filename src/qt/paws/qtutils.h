...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, PAWSGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, PAWSGUI* gui, double posX = 3);
