...
#include "qt/paws/forms/ui_masternodeswidget.h"

#include "qt/paws/qtutils.h"
#include "qt/paws/mnrow.h"
#include "qt/paws/mninfodialog.h"
#include "qt/paws/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(PAWSGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:18765 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (GetMstrNodCollateral(chainActive.Height()) * COIN)) {
        inform(tr("Not enough balance to create a masternode, 6,000 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
