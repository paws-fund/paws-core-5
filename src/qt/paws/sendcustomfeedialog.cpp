...
#include "qt/paws/sendcustomfeedialog.h"
#include "qt/paws/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(PAWSGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &PAWSGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
