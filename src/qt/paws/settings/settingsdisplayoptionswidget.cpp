...
#include "qt/paws/settings/forms/ui_settingsdisplayoptionswidget.h"
#include <QListView>
#include <QSettings>
#include <QDir>
#include "guiutil.h"
...
SettingsDisplayOptionsWidget::SettingsDisplayOptionsWidget(PAWSGUI* _window, QWidget *parent) :
