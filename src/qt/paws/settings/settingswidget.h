...
#include <QWidget>
#include "qt/paws/pwidget.h"
#include "qt/paws/settings/settingsbackupwallet.h"
#include "qt/paws/settings/settingsexportcsv.h"
#include "qt/paws/settings/settingsbittoolwidget.h"
#include "qt/paws/settings/settingssignmessagewidgets.h"
#include "qt/paws/settings/settingswalletrepairwidget.h"
#include "qt/paws/settings/settingswalletoptionswidget.h"
#include "qt/paws/settings/settingsmainoptionswidget.h"
#include "qt/paws/settings/settingsdisplayoptionswidget.h"
#include "qt/paws/settings/settingsmultisendwidget.h"
#include "qt/paws/settings/settingsinformationwidget.h"
#include "qt/paws/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(PAWSGUI* parent);
    ~SettingsWidget();
