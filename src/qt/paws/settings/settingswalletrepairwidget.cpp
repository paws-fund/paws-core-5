...
#include "qt/paws/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/paws/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(PAWSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to PAWSGUI::handleRestart()
