...
#include "qt/paws/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(PAWSGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start PAWS on system login"));
