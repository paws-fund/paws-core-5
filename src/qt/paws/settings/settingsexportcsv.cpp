...
#include "qt/paws/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(PAWSGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("PAWS_tx_csv_export(*.csv)") : tr("PAWS_addresses_csv_export(*.csv)"),
                                        nullptr);
