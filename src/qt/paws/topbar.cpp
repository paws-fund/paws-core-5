...
#include "qt/paws/topbar.h"
#include "qt/paws/forms/ui_topbar.h"
#include "qt/paws/lockunlock.h"
#include "qt/paws/qtutils.h"
#include "qt/paws/receivedialog.h"
#include "qt/paws/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/paws/balancebubble.h"
...
TopBar::TopBar(PAWSGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopPaws, ui->labelAmountTopShieldedPaws}, "amount-small-topbar");
    setCssProperty({ui->labelAmountPaws}, "amount-topbar");
    setCssProperty({ui->labelPendingPaws, ui->labelImmaturePaws}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // PAWS Total
    QString totalPaws = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // PAWS
    // Top
    ui->labelAmountTopPaws->setText(totalTransparent);
    ui->labelAmountTopShieldedPaws->setText(totalShielded);
    // Expanded
    ui->labelAmountPaws->setText(totalPaws);
    ui->labelPendingPaws->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmaturePaws->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
