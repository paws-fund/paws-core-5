...
#include "qt/paws/furabstractlistitemdelegate.h"
#include "qt/paws/txviewholder.h"
#include "qt/paws/tooltipmenu.h"
#include "qt/paws/sendmultirow.h"
#include "qt/paws/coldstakingmodel.h"
#include "qt/paws/contactsdropdown.h"
#include "qt/paws/addressholder.h"
...
public:
    explicit ColdStakingWidget(PAWSGUI* parent);
    ~ColdStakingWidget();
