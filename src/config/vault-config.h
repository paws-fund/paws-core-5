/* src/config/vault-config.h.  Generated from vault-config.h.in by configure.  */
/* src/config/vault-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/vault-project/vault/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VAULT Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VAULT Core 5.3.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vault"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://vault.org/"
