/* src/config/paws-config.h.  Generated from paws-config.h.in by configure.  */
/* src/config/paws-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef PAWS_CONFIG_H

#define PAWS_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/paws-project/paws/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "PAWS Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "PAWS Core 5.3.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "paws"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://paws.org/"
