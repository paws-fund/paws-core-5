...
// Copyright (c) 2016-2020 The PAWS developers
...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 PAWS
    ...
    MAKE_SPORK_DEF(SPORK_17_CHARITY_FUND,                            0ULL), // OFF
    ...
    MAKE_SPORK_DEF(SPORK_24_FORCE_ENABLED_MASTERNODE,       4070908800ULL), // OFF
};
...
// PAWS: on startup load spork values from previous session if they exist in the sporkDB
