...
class SaplingFillBlockTest(PawsTestFramework):
    ...
    def utxo_splitter(self, node_from, n_inputs, node_to):
        ...
        # split each one in 100 (use fixed 0.05 PAWS fee)
        for u in utxos:
    ...
    def run_test(self):
        ...
        # Split 10 utxos (of 250 PAWS each) in 1000 new utxos of ~2.5 PAWS each (to alice)
        UTXOS_TO_SPLIT = 10
        ...
        # Now alice shields the new utxos individually (fixed 0.2 PAWS fee --> ~2.3 PAWS notes)
