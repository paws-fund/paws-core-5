...
from test_framework.test_framework import PawsTier2TestFramework
...
class MasternodeGovernanceBasicTest(PawsTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.paws.org/t/test-proposal"
