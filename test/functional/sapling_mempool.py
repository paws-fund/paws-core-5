#!/usr/bin/env python3
# Copyright (c) 2020 The PAWS Core developers
...
class SaplingMempoolTest(PawsTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 PAWS note to Alice
        ...
        # miner sends another 10 PAWS note to Alice
