...
from test_framework.paws_node import PawsTestNode
...
class PAWS_ColdStakingTest(PawsTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(PawsTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 PAWS from the pot)
