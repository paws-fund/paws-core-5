...
class ListReceivedTest (PawsTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 PAWS.
        ...
        # Send 1 PAWS to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 PAWS sending them all (fee is 0.1 PAWS)
        ...
        # Confirm transaction (2 PAWS from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 PAWS, send 0.6 PAWS + 0.05 PAWS fee
