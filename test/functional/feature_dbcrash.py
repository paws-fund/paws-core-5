...
from test_framework.test_framework import PawsTestFramework
...
class ChainstateWriteCrashTest(PawsTestFramework):
    ...
    def set_test_params(self):
        ...
        self.chain_params = ['-nuparams=v5_shield:90000', '-nuparams=PAWS_v4.0:90000',
                             '-nuparams=PAWS_v3.4:90000', '-nuparams=Zerocoin_Public:90000',
    ...
    def restart_node(self, node_index, expected_tip):
        ...
        while time.time() - time_start < 120:
            try:
                ...
                # If pawsd exits, then try again.  wait_for_node_exit()
                # should raise an exception if pawsd doesn't exit.
                self.wait_for_node_exit(node_index, timeout=10)
            self.crashed_on_restart += 1
            time.sleep(1)

        # If we got here, pawsd isn't coming back up on restart.  Could be a
        # bug in pawsd, or we've gotten unlucky with our dbcrash ratio --
