...
class BudgetProposalTest(PawsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid PAWS address")
        assert_raises_rpc_error(-5, "Invalid PAWS address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 PAWS allowed" % invalid_amt, self.nodes[0].preparebudget,
