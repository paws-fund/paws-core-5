#!/usr/bin/env python3
# Copyright (c) 2021 The PAWS developers
...
class BlockIndexStatsTest(PawsTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 PAWS "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 PAWS + 9 notes of 5 PAWS + 1 note of 4 PAWS (using 1.0 fee)
