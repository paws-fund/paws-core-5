...
paws.conf           | contains configuration settings for pawsd or paws-qt
pawsd.pid           | stores the process id of pawsd while running
...
debug.log           | contains debug information and general logging generated by pawsd or paws-qt
